    ...
    private Handler GetNewsHandler=new Handler(){
        public  void handleMessage(Message msg){
            if(msg.what == 0x123){
                ...
                Toast.makeText(LoginActivity2.this,res, Toast.LENGTH_LONG).show();
                if(res.trim().equals("ok")){
                    showProgress(false);

                    Intent intent=new Intent(LoginActivity2.this,MainMenu.class);
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
           ...
           // mAuthTask.execute((Void) null);
            //这里应该开启县城了
            final String url="http://121.42.211.211/yujie/CheckUser.php";
            final String para="email="+mEmailView.getText()+"&password="+mPasswordView.getText()+"";
            new Thread(){
                public  void run(){
