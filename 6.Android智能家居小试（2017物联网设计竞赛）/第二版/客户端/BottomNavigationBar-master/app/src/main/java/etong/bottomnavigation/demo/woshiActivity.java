...
public class woshiActivity extends AppCompatActivity {
    private String[] data;
    ...
    private Handler GetNewsHandler=new Handler(){
        public  void handleMessage(Message msg){
            if(msg.what == 0x123){
                ...
                //  Toast.ma
             //   Toast.makeText(woshiActivity.this,res, Toast.LENGTH_LONG).show();
                //    data.setText(res);
                realData=res.split("\n");
              //  Toast.makeText(woshiActivity.this,realData[1], Toast.LENGTH_LONG).show();
                setData(realData);
                //setImage(realData[1]);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_woshi);
    ...
    public void getNewDate(){
        final String url="http://121.42.211.211/lot/getHomeThree.php";
